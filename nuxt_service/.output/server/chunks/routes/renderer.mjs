...
import { h as defineRenderHandler, i as buildAssetsURL, p as publicAssetsURL, g as getQuery, e as createError, j as getRouteRules, u as useRuntimeConfig, k as getResponseStatus, l as getResponseStatusText, b as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"zh-cmn-Hans"},"charset":"utf-8","viewport":"width=device-width, initial-scale=1","title":"协同系统(内网)"};
...
const getServerEntry = () => import('../build/server.mjs').then(function (n) { return n.bS; }).then((r) => r.default || r);
