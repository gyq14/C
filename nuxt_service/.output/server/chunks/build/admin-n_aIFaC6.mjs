...
import { defineComponent, ref, provide, openBlock, createElementBlock, normalizeClass, unref, renderSlot, getCurrentInstance, inject, createElementVNode, createBlock, withCtx, resolveDynamicComponent, toDisplayString, computed, reactive, watch, h, Fragment, withDirectives, vShow, watchEffect, toRef, normalizeStyle, useSSRContext, createVNode, createCommentVNode, createTextVNode, Transition, mergeProps, nextTick, resolveComponent, renderList } from 'vue';
...
import { c as buildProps, aQ as iconPropType, h as useLocale, g as useNamespace, d as definePropType, q as ElIcon, w as withInstall, bc as withNoopInstall, b7 as throwError$1, D as arrow_down_default, A as arrow_right_default, bQ as more_default, aW as useResizeObserver, bf as componentSizes, n as useFormSize, x as isUndefined, v as _export_sfc, ba as addClass, bb as removeClass, y as hasClass, bu as useTimeoutFn, b8 as useUserStore, bn as useRouter, bK as useAppConfig, bM as useNuxtApp, _ as _export_sfc$1, bL as navigateTo } from './server.mjs';
import { a as ElTooltip, C as ClickOutside, c as ElScrollbar } from './index-CZuFgaK7.mjs';
import { isNil } from 'lodash-unified';
import { E as ElCollapseTransition } from './index-DvoLHlr0.mjs';
import { TinyColor } from '@ctrl/tinycolor';
import { isString, isObject, isArray } from '@vue/shared';
import { m as mutable } from './index-DUiHV-eU.mjs';
import { f as flattedChildren } from './vnode-Cs2GWOIH.mjs';
import __nuxt_component_2 from './index-PqHP4zmq.mjs';
...
var Text = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__file", "text.vue"]]);
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(_attrs)} data-v-ba8ea842><div class="brand" data-v-ba8ea842><img class="logo"${ssrRenderAttr("src", _imports_0)} data-v-ba8ea842><div class="title" data-v-ba8ea842>${ssrInterpolate(unref(userStore).name)}</div><div data-v-ba8ea842>`);
      _push(ssrRenderComponent(_component_el_tag, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(userStore).role)}`);
          } else {
            return [
              createTextVNode(toDisplayString(unref(userStore).role), 1)
            ];
          }
        }),
        _: 1
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc$1(_sfc_main$6, [["__scopeId", "data-v-ba8ea842"]]);
const _sfc_main$5 = {};
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc$1(_sfc_main$5, [["ssrRender", _sfc_ssrRender$1]]);
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_LayoutMenuItem = _sfc_main$4;
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_LayoutSideMenu = _sfc_main$3;
...
//# sourceMappingURL=admin-n_aIFaC6.mjs.map
