...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-cf38936d><div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "margin-bottom": "20px" })}" data-v-cf38936d>`);
      ...
      _push(`<div style="${ssrRenderStyle({ "margin-left": "20px" })}" data-v-cf38936d>\u5408\u8BA1 ${ssrInterpolate(filteredTodos.value.length)} \u6761</div></div>`);
      _push(ssrRenderComponent(_component_el_space, { wrap: "" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            ssrRenderList(filteredTodos.value, (todo) => {
              _push2(`<div class="custom-card" data-v-cf38936d${_scopeId}><span class="card-header" data-v-cf38936d${_scopeId}><div data-v-cf38936d${_scopeId}>${ssrInterpolate(todo.title)}</div>`);
              ...
              _push2(`<div class="card-content" data-v-cf38936d${_scopeId}><strong data-v-cf38936d${_scopeId}>\u5907\u6CE8:</strong> ${ssrInterpolate(todo.description)}</div></div>`);
            });
            _push2(`<!--]-->`);
          } else {
            return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/leader/TaskContainer.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const TaskContainer = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["__scopeId", "data-v-cf38936d"]]);

export { TaskContainer as default };
//# sourceMappingURL=TaskContainer-DTJt4tf1.mjs.map
