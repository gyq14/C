import { _ as __nuxt_component_0, a as __nuxt_component_1 } from './subtask-ChqMNOFZ.mjs';
import { defineComponent, unref, useSSRContext } from 'vue';
import { ssrRenderComponent } from 'vue/server-renderer';
import { bm as useRoute } from './server.mjs';
import 'vue-router';
...
const type = `/admin/MessageCenter/Todos`;
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_SubpageTask = __nuxt_component_0;
      const _component_SubpageSubtask = __nuxt_component_1;
      _push(`<!--[-->`);
      if (unref(route).params.type === "Task" && unref(route).params.id) {
        _push(`<div>`);
        _push(ssrRenderComponent(_component_SubpageTask, { routetype: type }, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(route).params.type === "todo2" && unref(route).params.id) {
        _push(`<div>`);
        _push(ssrRenderComponent(_component_SubpageSubtask, { routetype: type }, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<!---->`);
      }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/leader/MessageCenter/Todos-[type]/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_id_-BSl3ULoh.mjs.map
