...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-0e2a668e><div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "margin-bottom": "20px" })}" data-v-0e2a668e>`);
      ...
      _push(`<div style="${ssrRenderStyle({ "margin-left": "20px" })}" data-v-0e2a668e>\u5408\u8BA1 ${ssrInterpolate(filteredTodos.value.length)} \u6761</div></div>`);
      _push(ssrRenderComponent(_component_el_space, { wrap: "" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            ssrRenderList(filteredTodos.value, (todo) => {
              _push2(`<div class="custom-card" data-v-0e2a668e${_scopeId}><span class="card-header" data-v-0e2a668e${_scopeId}><div data-v-0e2a668e${_scopeId}>${ssrInterpolate(todo.title)}</div>`);
              ...
              _push2(`<div class="card-content" data-v-0e2a668e${_scopeId}><strong data-v-0e2a668e${_scopeId}>\u5907\u6CE8:</strong> ${ssrInterpolate(todo.description)}</div></div>`);
            });
            _push2(`<!--]-->`);
          } else {
            return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/SubtaskCenter.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const SubtaskCenter = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["__scopeId", "data-v-0e2a668e"]]);

export { SubtaskCenter as default };
//# sourceMappingURL=SubtaskCenter-hGZZhPqZ.mjs.map
