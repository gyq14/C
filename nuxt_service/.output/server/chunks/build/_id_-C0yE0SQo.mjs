...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="task-container" data-v-2fb3c829><div class="task-info" data-v-2fb3c829><h2 data-v-2fb3c829>\u4EFB\u52A1\u57FA\u672C\u4FE1\u606F</h2>`);
      if (unref(task)) {
        _push(`<div data-v-2fb3c829><div data-v-2fb3c829><strong data-v-2fb3c829>\u4EFB\u52A1\u540D\u79F0:</strong> ${ssrInterpolate(unref(task).name)}</div><div data-v-2fb3c829><strong data-v-2fb3c829>\u4EFB\u52A1\u72B6\u6001:</strong> ${ssrInterpolate(unref(task).status)}</div><div data-v-2fb3c829><strong data-v-2fb3c829>\u622A\u6B62\u65F6\u95F4:</strong> ${ssrInterpolate(unref(task).deadline)}</div><div data-v-2fb3c829><strong data-v-2fb3c829>\u8D1F\u8D23\u4EBA:</strong> ${ssrInterpolate(unref(task).responsible.join(", "))}</div><div data-v-2fb3c829><strong data-v-2fb3c829>\u63CF\u8FF0:</strong> ${ssrInterpolate(unref(task).description || "\u65E0\u63CF\u8FF0")}</div><div data-v-2fb3c829><strong data-v-2fb3c829>\u9644\u4EF6:</strong> `);
        if (unref(task).attachments) {
          _push(`<span data-v-2fb3c829>\u6709\u9644\u4EF6</span>`);
        } else {
          _push(`<span data-v-2fb3c829>\u65E0\u9644\u4EF6</span>`);
        }
        _push(`</div></div>`);
      } else {
        _push(`<div data-v-2fb3c829>`);
      ...
      _push(`</div><div class="task-subtasks" data-v-2fb3c829><div class="subtasks-header" data-v-2fb3c829><div data-v-2fb3c829><h2 data-v-2fb3c829>\u5B50\u4EFB\u52A1\u5217\u8868</h2></div><div data-v-2fb3c829>`);
      ...
      _push(ssrRenderComponent(unref(ElDialog), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div slot="footer" class="dialog-footer" data-v-2fb3c829${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/user/TaskCenter-[type]/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _id_ = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["__scopeId", "data-v-2fb3c829"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-C0yE0SQo.mjs.map
