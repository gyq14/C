...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const filteredTodos = computed(() => {
      return subtaskStore.unCompletedsubtaskData.filter((item) => item.title.includes(searchQuery.value));
    });
    ref(0);
    const searchQuery = ref("");
    const goToProjectDetail = (id) => {
      router.push(`/leader/SubtaskCenter-SubtaskCenter/${id}`);
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-96808ab9><div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "margin-bottom": "20px" })}" data-v-96808ab9>`);
      ...
      _push(`<div style="${ssrRenderStyle({ "margin-left": "20px" })}" data-v-96808ab9>\u5408\u8BA1 ${ssrInterpolate(filteredTodos.value.length)} \u6761</div></div>`);
      _push(ssrRenderComponent(_component_el_space, { wrap: "" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            ssrRenderList(filteredTodos.value, (todo) => {
              _push2(`<div class="custom-card" data-v-96808ab9${_scopeId}><span class="card-header" data-v-96808ab9${_scopeId}><div data-v-96808ab9${_scopeId}>${ssrInterpolate(todo.title)}</div>`);
              ...
              _push2(`<div class="card-content" data-v-96808ab9${_scopeId}><strong data-v-96808ab9${_scopeId}>\u5907\u6CE8:</strong> ${ssrInterpolate(todo.description)}</div></div>`);
            });
            _push2(`<!--]-->`);
          } else {
            return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/leader/SubtaskCenter.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const SubtaskCenter = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["__scopeId", "data-v-96808ab9"]]);

export { SubtaskCenter as default };
//# sourceMappingURL=SubtaskCenter-BPEz2zUC.mjs.map
