...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const goToProjectDetail = (id) => {
      router.push(`/user/SubtaskCenter-SubtaskCenter/${id}`);
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-f1607726><div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "margin-bottom": "20px" })}" data-v-f1607726>`);
      ...
      _push(`<div style="${ssrRenderStyle({ "margin-left": "20px" })}" data-v-f1607726>\u5408\u8BA1 ${ssrInterpolate(filteredTodos.value.length)} \u6761</div></div>`);
      _push(ssrRenderComponent(_component_el_space, { wrap: "" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            ssrRenderList(filteredTodos.value, (todo) => {
              _push2(`<div class="custom-card" data-v-f1607726${_scopeId}><span class="card-header" data-v-f1607726${_scopeId}><div data-v-f1607726${_scopeId}>${ssrInterpolate(todo.title)}</div>`);
              ...
              _push2(`<div class="card-content" data-v-f1607726${_scopeId}><strong data-v-f1607726${_scopeId}>\u5907\u6CE8:</strong> ${ssrInterpolate(todo.description)}</div></div>`);
            });
            _push2(`<!--]-->`);
          } else {
            return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/user/SubtaskCenter.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const SubtaskCenter = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["__scopeId", "data-v-f1607726"]]);

export { SubtaskCenter as default };
//# sourceMappingURL=SubtaskCenter-48gLpvNL.mjs.map
