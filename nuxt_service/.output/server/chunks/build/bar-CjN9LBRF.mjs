import { _ as __nuxt_component_7$1 } from './client-only-DO9VxlB2.mjs';
import { useSSRContext, defineComponent, ref, watch, mergeProps } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent } from 'vue/server-renderer';
import { H as __extends, au as createSeriesData, a7 as createSymbol, V as SeriesModel, av as enterEmphasis, aw as leaveEmphasis, K as updateProps$1, L as saveOldStyle, J as initProps, P as getLabelStatesModels, ax as normalizeSymbolOffset, O as setLabelStyle, ay as getDefaultLabel, N as toggleHoverEmphasis, Z as getECData, az as removeElement, aA as normalizeSymbolSize, aB as convertToColorString, M as setStatesStylesFromModel, aC as queryDataIndex, R as ChartView, aD as setStatesFlag, aE as getDefaultInterpolatedLabel, aF as interpolateRawValues, as as labelInner, aG as isDimensionStacked, aH as createFloat32Array, ad as SPECIAL_STATES, aI as isCoordinateSystemType, aJ as createGridClipPath, aK as createPolarClipPath, ai as use, aj as install$5, ak as install$1, aL as install$1$1, _ as _export_sfc$1, aM as install$4, aN as traverseElements, aO as dataSample, aP as createRenderPlanner } from './server.mjs';
import { i as install$3, a as install$2, b as installLabelLayout } from './doughnut-BAo8Tv3m.mjs';
import Group from 'zrender/lib/graphic/Group.js';
import * as zrUtil from 'zrender/lib/core/util.js';
import { extend, map, isNumber, isObject } from 'zrender/lib/core/util.js';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    watch(() => props.data, (newData) => {
      ...
      option.value.xAxis.data = newData.map((item) => item.date);
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_client_only = __nuxt_component_7$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex" }, _attrs))} data-v-890d3532>`);
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Echart/line.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const __nuxt_component_6 = /* @__PURE__ */ _export_sfc$1(_sfc_main$2, [["__scopeId", "data-v-890d3532"]]);
  ...
  setup(__props) {
    ...
    const option = ref({
      ...
      xAxis: {
        ...
        boundaryGap: true,
        // 增加左侧间隔
        //   boundaryGap: false, // 使折线图从x轴的最左边开始
        data: props.data.map((item) => item.date),
        // 使用传入的数据中的日期作为x轴
        axisLabel: {
          // rotate: 45, // X轴标签旋转45度
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_client_only = __nuxt_component_7$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex" }, _attrs))} data-v-11678383>`);
      _push(ssrRenderComponent(_component_client_only, null, {}, _parent));
      _push(`</div>`);
    };
  }
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Echart/line_area.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_7 = /* @__PURE__ */ _export_sfc$1(_sfc_main$1, [["__scopeId", "data-v-11678383"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    watch(() => props.data, (newData) => {
      option.value.series[0].data = newData.map((item) => item.value);
      option.value.xAxis.data = newData.map((item) => item.category);
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_client_only = __nuxt_component_7$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex" }, _attrs))} data-v-71ee7691>`);
      _push(ssrRenderComponent(_component_client_only, null, {}, _parent));
      _push(`</div>`);
    };
  }
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Echart/bar.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_8 = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["__scopeId", "data-v-71ee7691"]]);

export { __nuxt_component_6 as _, __nuxt_component_7 as a, __nuxt_component_8 as b };
//# sourceMappingURL=bar-CjN9LBRF.mjs.map
