import { _ as __nuxt_component_0 } from './bind-CdUms2g5.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const type = `/leader/${route.params.type}`;
    return (_ctx, _push, _parent, _attrs) => {
      const _component_SubpageBind = __nuxt_component_0;
      if (unref(route).params.id) {
        _push(`<div${ssrRenderAttrs(_attrs)}>`);
        _push(ssrRenderComponent(_component_SubpageBind, { routetype: type }, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<!---->`);
      }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/leader/SubtaskCenter-[type]/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_id_-DVJ-_7_0.mjs.map
