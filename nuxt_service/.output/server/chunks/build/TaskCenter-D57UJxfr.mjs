...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const goToProjectDetail = (id) => {
      router.push(`/user/TaskCenter-TaskCenter/${id}`);
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-223ae622><div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "margin-bottom": "20px" })}" data-v-223ae622>`);
      ...
      _push(`<div style="${ssrRenderStyle({ "margin-left": "20px" })}" data-v-223ae622>\u5408\u8BA1 ${ssrInterpolate(filteredTodos.value.length)} \u6761</div></div>`);
      _push(ssrRenderComponent(_component_el_dialog, {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="dialog-footer" data-v-223ae622${_scopeId}>`);
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_el_row, null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div style="${ssrRenderStyle({ "display": "flex" })}" data-v-223ae622${_scopeId5}>`);
                        ...
                        _push4(ssrRenderComponent(_component_el_upload, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(`<div data-v-223ae622${_scopeId4}>\u4E0A\u4F20\u6587\u4EF6</div>`);
                            } else {
                              return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(filteredTodos.value, (todo) => {
              _push2(`<div class="custom-card" data-v-223ae622${_scopeId}><span class="card-header" data-v-223ae622${_scopeId}><div data-v-223ae622${_scopeId}>${ssrInterpolate(todo.title)}</div>`);
              ...
              _push2(`<div class="card-content" data-v-223ae622${_scopeId}><strong data-v-223ae622${_scopeId}>\u5907\u6CE8:</strong> ${ssrInterpolate(todo.description)}</div></div>`);
            });
            _push2(`<!--]-->`);
          } else {
            return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/user/TaskCenter.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const TaskCenter = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["__scopeId", "data-v-223ae622"]]);

export { TaskCenter as default };
//# sourceMappingURL=TaskCenter-D57UJxfr.mjs.map
