...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="flex justify-between items-center" data-v-504b0fdd><div class="text-2xl font-bold italic text-blue-600" data-v-504b0fdd>\u4EA7\u4E1A\u94FE\u534F\u540C\u8BBE\u8BA1\u5206\u6790\u770B\u677F</div><div class="flex items-center space-x-4" data-v-504b0fdd>`);
      ...
      _push(`<div class="grid grid-cols-2 md:grid-cols-6 lg:grid-cols-6 gap-6" data-v-504b0fdd>`);
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="text-center font-bold text-2xl" data-v-504b0fdd${_scopeId}>\u5DF2\u5B8C\u6210\u4EFB\u52A1\u6570\u91CF</div><div class="text-center font-bold text-3xl mb-3" data-v-504b0fdd${_scopeId}>15</div><div class="text-center font-bold text-2xl" data-v-504b0fdd${_scopeId}>\u5DF2\u5B8C\u6210\u5B50\u4EFB\u52A1\u6570\u91CF</div><div class="text-center font-bold text-3xl" data-v-504b0fdd${_scopeId}>120</div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="text-center font-bold text-sm" data-v-504b0fdd${_scopeId}>\u672A\u5B8C\u6210\u4EFB\u52A1\u6570\u91CF</div><div class="text-center font-bold text-sm" data-v-504b0fdd${_scopeId}>1</div><div class="text-center font-bold text-sm" data-v-504b0fdd${_scopeId}>\u672A\u5B8C\u6210\u5B50\u4EFB\u52A1\u6570\u91CF</div><div class="text-center font-bold text-sm" data-v-504b0fdd${_scopeId}>5</div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="text-center font-bold text-sm" data-v-504b0fdd${_scopeId}>\u9884\u671F\u4EFB\u52A1\u6570\u91CF</div><div class="text-center font-bold text-sm" data-v-504b0fdd${_scopeId}>1</div><div class="text-center font-bold text-sm" data-v-504b0fdd${_scopeId}>\u903E\u671F\u4EFB\u52A1\u6570\u91CF</div><div class="text-center font-bold text-sm" data-v-504b0fdd${_scopeId}>5</div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-lg font-semibold text-gray-700" data-v-504b0fdd${_scopeId}>\u903E\u671F\u4F9B\u5E94\u5546\u7C7B\u578B</span>`);
            _push2(ssrRenderComponent(_component_el_divider, { style: { "margin": "0 0" } }, null, _parent2, _scopeId));
            _push2(`<div class="flex justify-center" data-v-504b0fdd${_scopeId}>`);
      ...
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-lg font-semibold text-gray-700" data-v-504b0fdd${_scopeId}>\u903E\u671F\u539F\u56E0</span>`);
            _push2(ssrRenderComponent(_component_el_divider, { style: { "margin": "0 0" } }, null, _parent2, _scopeId));
            _push2(`<div class="flex justify-center" data-v-504b0fdd${_scopeId}>`);
            _push2(ssrRenderComponent(_component_EchartDoughnut, {
              width: "460px",
      ...
      _push(`</div><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-3" data-v-504b0fdd>`);
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-lg font-semibold text-gray-700" data-v-504b0fdd${_scopeId}>\u6708\u5EA6\u4EFB\u52A1\u534F\u540C\u9891\u6B21(\u70ED\u5EA6)\u8D70\u52BF\u56FE</span>`);
            _push2(ssrRenderComponent(_component_el_divider, { style: { "margin": "0 0" } }, null, _parent2, _scopeId));
            _push2(`<div class="flex justify-center" data-v-504b0fdd${_scopeId}>`);
      ...
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-lg font-semibold text-gray-700" data-v-504b0fdd${_scopeId}>\u6708\u5EA6\u5B50\u4EFB\u52A1\u534F\u540C\u9891\u6B21(\u70ED\u5EA6)\u8D70\u52BF\u56FE</span>`);
            _push2(ssrRenderComponent(_component_el_divider, { style: { "margin": "0 0" } }, null, _parent2, _scopeId));
            _push2(`<div class="flex justify-center" data-v-504b0fdd${_scopeId}>`);
      ...
      _push(`</div><div class="grid" data-v-504b0fdd>`);
      _push(ssrRenderComponent(_component_el_card, {
        class: "bg-gray-100",
        shadow: "always",
        style: { "border-radius": "8px" }
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-lg font-semibold text-gray-700" data-v-504b0fdd${_scopeId}>\u5458\u5DE5\u534F\u540C\u9891\u6B21\u6C47\u603B</span>`);
            _push2(ssrRenderComponent(_component_el_divider, { style: { "margin": "0 0" } }, null, _parent2, _scopeId));
            _push2(`<div class="flex justify-center" data-v-504b0fdd${_scopeId}>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc$1(_sfc_main$1, [["__scopeId", "data-v-504b0fdd"]]);
...
//# sourceMappingURL=index-DS1RgE8L.mjs.map
