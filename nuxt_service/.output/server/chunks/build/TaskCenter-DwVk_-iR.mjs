...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const filteredTodos = computed(() => {
      return taskstore.tasksData.filter((todo) => todo.title.includes(searchQuery.value));
    });
    ref(0);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-feefe33a><div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "margin-bottom": "20px" })}" data-v-feefe33a>`);
      ...
      _push(`<div style="${ssrRenderStyle({ "margin-left": "20px" })}" data-v-feefe33a>\u5408\u8BA1 ${ssrInterpolate(filteredTodos.value.length)} \u6761</div></div>`);
      _push(ssrRenderComponent(_component_el_dialog, {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="dialog-footer" data-v-feefe33a${_scopeId}>`);
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_el_row, null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div style="${ssrRenderStyle({ "display": "flex" })}" data-v-feefe33a${_scopeId5}>`);
                        ...
                        _push4(ssrRenderComponent(_component_el_upload, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(`<div data-v-feefe33a${_scopeId4}>\u4E0A\u4F20\u6587\u4EF6</div>`);
                            } else {
                              return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(filteredTodos.value, (todo) => {
              _push2(`<div class="custom-card" data-v-feefe33a${_scopeId}><span class="card-header" data-v-feefe33a${_scopeId}><div data-v-feefe33a${_scopeId}>${ssrInterpolate(todo.title)}</div>`);
              ...
              _push2(`<div class="card-content" data-v-feefe33a${_scopeId}><strong data-v-feefe33a${_scopeId}>\u5907\u6CE8:</strong> ${ssrInterpolate(todo.description)}</div></div>`);
            });
            _push2(`<!--]-->`);
          } else {
            return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/leader/TaskCenter.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const TaskCenter = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["__scopeId", "data-v-feefe33a"]]);

export { TaskCenter as default };
//# sourceMappingURL=TaskCenter-DwVk_-iR.mjs.map
