...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="flex justify-between items-center" data-v-832684a8><div class="text-2xl font-bold italic text-blue-600" data-v-832684a8>\u9879\u76EE\u770B\u677F</div><div class="flex items-center space-x-4" data-v-832684a8>`);
      ...
      _push(`<div class="grid grid-cols-2 md:grid-cols-6 lg:grid-cols-6 gap-6" data-v-832684a8>`);
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="text-center font-bold text-2xl" data-v-832684a8${_scopeId}>\u5DF2\u5B8C\u6210\u9879\u76EE\u6570\u91CF</div><div class="text-center font-bold text-3xl mb-3" data-v-832684a8${_scopeId}>15</div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="text-center font-bold text-xl mb-3 mt-3" data-v-832684a8${_scopeId}>\u672A\u5B8C\u6210\u9879\u76EE\u6570\u91CF</div><div class="text-center font-bold text-xl mb-1" data-v-832684a8${_scopeId}>1</div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="text-center font-bold text-xl mb-3 mt-3" data-v-832684a8${_scopeId}>\u903E\u671F\u9879\u76EE\u6570\u91CF</div><div class="text-center font-bold text-xl mb-1" data-v-832684a8${_scopeId}>5</div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-lg font-semibold text-gray-700" data-v-832684a8${_scopeId}>\u903E\u671F\u9879\u76EE\u7C7B\u578B</span>`);
            _push2(ssrRenderComponent(_component_el_divider, { style: { "margin": "0 0" } }, null, _parent2, _scopeId));
            _push2(`<div class="flex justify-center" data-v-832684a8${_scopeId}>`);
      ...
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-lg font-semibold text-gray-700" data-v-832684a8${_scopeId}>\u903E\u671F\u539F\u56E0</span>`);
            _push2(ssrRenderComponent(_component_el_divider, { style: { "margin": "0 0" } }, null, _parent2, _scopeId));
            _push2(`<div class="flex justify-center" data-v-832684a8${_scopeId}>`);
            _push2(ssrRenderComponent(_component_EchartDoughnut, {
              width: "460px",
      ...
      _push(`</div><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-3" data-v-832684a8>`);
      _push(ssrRenderComponent(_component_el_card, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-lg font-semibold text-gray-700" data-v-832684a8${_scopeId}>\u6708\u5EA6\u9879\u76EE\u534F\u540C\u9891\u6B21(\u70ED\u5EA6)\u8D70\u52BF\u56FE</span>`);
            _push2(ssrRenderComponent(_component_el_divider, { style: { "margin": "0 0" } }, null, _parent2, _scopeId));
            _push2(`<div class="flex justify-center" data-v-832684a8${_scopeId}>`);
      ...
      _push(`</div><div class="grid" data-v-832684a8>`);
      _push(ssrRenderComponent(_component_el_card, {
        class: "bg-gray-100",
        shadow: "always",
        style: { "border-radius": "8px" }
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-lg font-semibold text-gray-700" data-v-832684a8${_scopeId}>\u5458\u5DE5\u534F\u540C\u9891\u6B21\u6C47\u603B</span>`);
            _push2(ssrRenderComponent(_component_el_divider, { style: { "margin": "0 0" } }, null, _parent2, _scopeId));
            _push2(`<div class="flex justify-center" data-v-832684a8${_scopeId}>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc$1(_sfc_main$1, [["__scopeId", "data-v-832684a8"]]);
...
const index = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["__scopeId", "data-v-24eab7a4"]]);

export { index as default };
//# sourceMappingURL=index-scwDco14.mjs.map
