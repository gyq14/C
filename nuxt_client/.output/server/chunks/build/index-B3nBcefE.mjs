import { defineComponent, getCurrentInstance, ref, computed, watch, inject, h, openBlock, createElementBlock, renderSlot, provide, Fragment, isRef, watchEffect, unref, resolveComponent, resolveDirective, createBlock, withCtx, createElementVNode, normalizeClass, createVNode, renderList, createTextVNode, toDisplayString, withDirectives, normalizeStyle, createCommentVNode, vShow, Comment, toRefs, nextTick, render } from 'vue';
import { debounce, merge, isEqual, flatMap, get } from 'lodash-unified';
import { c as ElScrollbar, b as ElTooltip, C as ClickOutside } from './index-D0bGVFfM.mjs';
import { isArray, isString, hasOwn, isFunction, isObject } from '@vue/shared';
import { a4 as ElIcon, b9 as arrow_down_default, b8 as arrow_up_default, a8 as useLocale, a3 as useNamespace, ah as addClass, ag as removeClass, bk as isClient, aa as withInstall, br as withNoopInstall, ae as _export_sfc, aN as useFormSize, aG as useSizeProp, bi as isElement, a$ as hasClass, ab as isBoolean, ba as isNumber, bs as getProp, ac as isUndefined, b1 as arrow_right_default, a5 as loading_default, bl as throwError$1 } from './server.mjs';
...
const getColumnByKey = function(table, columnKey) {
  ...
  if (!column)
    throwError$1("ElTable", `No column matching with column-key: ${columnKey}`);
  return column;
};
...
//# sourceMappingURL=index-B3nBcefE.mjs.map
