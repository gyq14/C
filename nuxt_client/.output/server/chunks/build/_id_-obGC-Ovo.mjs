  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(route).params.id) {
        ...
        _push(ssrRenderComponent(_component_TodoTode2, { routetype: "/admin/MessageCenter/Todos" }, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<!---->`);
      }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/MessageCenter/Todos-[type]/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_id_-obGC-Ovo.mjs.map
