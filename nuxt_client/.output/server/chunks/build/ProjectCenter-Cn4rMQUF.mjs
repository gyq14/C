...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const goToProjectDetail = (id) => {
      router.push(`/leader/ProjectCenter-ProjectCenter/${id}`);
    };
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-60f53e15><div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "margin-bottom": "20px" })}" data-v-60f53e15>`);
      ...
      _push(`<div style="${ssrRenderStyle({ "margin-left": "20px" })}" data-v-60f53e15>\u5408\u8BA1 ${ssrInterpolate(filteredProjects.value.length)} \u6761</div></div>`);
      _push(ssrRenderComponent(_component_el_space, { wrap: "" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            ssrRenderList(filteredProjects.value, (project) => {
              _push2(`<div class="custom-card" data-v-60f53e15${_scopeId}><span class="card-header" data-v-60f53e15${_scopeId}><div data-v-60f53e15${_scopeId}>${ssrInterpolate(project.name)}</div>`);
              ...
              _push2(`<div class="card-content" data-v-60f53e15${_scopeId}><strong data-v-60f53e15${_scopeId}>\u5907\u6CE8:</strong> ${ssrInterpolate(project.description)}</div></div>`);
            });
            _push2(`<!--]-->`);
          } else {
            return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/leader/ProjectCenter.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ProjectCenter = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["__scopeId", "data-v-60f53e15"]]);

export { ProjectCenter as default };
//# sourceMappingURL=ProjectCenter-Cn4rMQUF.mjs.map
