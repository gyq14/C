import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, reactive, toRaw, isRef, isReactive, toRef, defineAsyncComponent, getCurrentScope, onScopeDispose, readonly, computed, unref, defineComponent, h, provide, shallowReactive, Suspense, nextTick, Fragment, Transition, openBlock, createElementBlock, normalizeClass, createElementVNode, renderSlot, createBlock, resolveDynamicComponent, createCommentVNode, toDisplayString, mergeProps, toRefs, createVNode, useSlots, withCtx, normalizeStyle, createTextVNode, TransitionGroup, useSSRContext, shallowRef, Text, createApp, effectScope, warn, onErrorCaptured, onServerPrefetch, isReadonly, markRaw, isShallow } from 'vue';
import { $ as $fetch$1, k as baseURL, l as hasProtocol, m as isScriptProtocol, n as joinURL, w as withQuery, f as createError$1, o as klona, q as defu, r as sanitizeStatusCode, v as defuFn, x as getContext, y as createHooks, z as parse, A as getRequestHeader, d as destr, B as isEqual, C as setCookie, D as getCookie, E as deleteCookie, F as toRouteMatcher, G as createRouter$1, H as getRequestHeaders } from '../_/nitro.mjs';
import { CapoPlugin, getActiveHead } from 'unhead';
import { defineHeadPlugin, composableNames } from '@unhead/shared';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { isArray, isObject as isObject$2, isString as isString$1, hasOwn, NOOP, isFunction as isFunction$1 } from '@vue/shared';
...
const _routes = [
  {
    name: "admin",
    path: "/admin",
    component: () => import('./admin-BJOQKuY9.mjs'),
    children: [
      {
        name: "admin+index",
        path: "",
        meta: __nuxt_page_meta$t || {},
        component: () => import('./index-Cyr9MQN1.mjs')
      },
      {
        name: "admin+MessageCenter",
        path: "MessageCenter",
        meta: __nuxt_page_meta$p || {},
        component: () => import('./MessageCenter-DduRJTpx.mjs'),
        children: [
          {
            name: "admin+MessageCenter+Notifications",
            path: "Notifications",
            meta: __nuxt_page_meta$s || {},
            component: () => import('./Notifications-CB_I46Rx.mjs')
          },
          {
            name: "admin+MessageCenter+Todos-[type]+[id]",
            path: "Todos-:type()/:id()",
            meta: __nuxt_page_meta$r || {},
            component: () => import('./_id_-obGC-Ovo.mjs')
          },
          {
            name: "admin+MessageCenter+Todos",
            path: "Todos",
            meta: __nuxt_page_meta$q || {},
            component: () => import('./Todos-Ci2Lphhn.mjs')
          }
        ]
      },
      {
        ...
        component: () => import('./Organization-DNhK7VuN.mjs'),
        children: [
          {
            name: "admin+Organization+User",
            path: "User",
            meta: __nuxt_page_meta$o || {},
            component: () => import('./User-BYzt3cN9.mjs')
          }
        ]
      },
      {
        name: "admin+ProjectCenter-[type]+[id]",
        path: "ProjectCenter-:type()/:id()",
        meta: __nuxt_page_meta$m || {},
        component: () => import('./_id_-hU0aWKFk.mjs')
      },
      {
        name: "admin+ProjectCenter",
        path: "ProjectCenter",
        meta: __nuxt_page_meta$l || {},
        component: () => import('./ProjectCenter-CxZzZZhi.mjs')
      },
      {
        name: "admin+ProjectContainer",
        path: "ProjectContainer",
        meta: __nuxt_page_meta$k || {},
        component: () => import('./ProjectContainer-BDnhv83f.mjs')
      },
      {
        name: "admin+UsersCenter",
        path: "UsersCenter",
        meta: __nuxt_page_meta$j || {},
        component: () => import('./UsersCenter-CWgHUHNm.mjs')
      }
    ]
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-_BMw_7lB.mjs')
  },
  {
    name: "leader",
    path: "/leader",
    component: () => import('./leader-CLWc8hQD.mjs'),
    children: [
      {
        name: "leader+index",
        path: "",
        meta: __nuxt_page_meta$i || {},
        component: () => import('./index-scwDco14.mjs')
      },
      {
        name: "leader+MessageCenter",
        path: "MessageCenter",
        meta: __nuxt_page_meta$e || {},
        component: () => import('./MessageCenter-CYEmlODG.mjs'),
        children: [
          {
            name: "leader+MessageCenter+Notifications",
            path: "Notifications",
            meta: __nuxt_page_meta$h || {},
            component: () => import('./Notifications-B6klurCr.mjs')
          },
          {
            name: "leader+MessageCenter+Todos-[type]+[id]",
            path: "Todos-:type()/:id()",
            meta: __nuxt_page_meta$g || {},
            component: () => import('./_id_-CT-5sSp_.mjs')
          },
          {
            name: "leader+MessageCenter+Todos",
            path: "Todos",
            meta: __nuxt_page_meta$f || {},
            component: () => import('./Todos-BbfdYefJ.mjs')
          }
        ]
      },
      {
        ...
        component: () => import('./Organization-CWddJlOj.mjs'),
        children: [
          {
            name: "leader+Organization+User",
            path: "User",
            meta: __nuxt_page_meta$d || {},
            component: () => import('./User-CihDedCo.mjs')
          }
        ]
      },
      {
        name: "leader+ProjectCenter-[type]+[id]",
        path: "ProjectCenter-:type()/:id()",
        meta: __nuxt_page_meta$b || {},
        component: () => import('./_id_-CYMsSNdq.mjs')
      },
      {
        name: "leader+ProjectCenter",
        path: "ProjectCenter",
        meta: __nuxt_page_meta$a || {},
        component: () => import('./ProjectCenter-Cn4rMQUF.mjs')
      },
      {
        name: "leader+ProjectContainer",
        path: "ProjectContainer",
        meta: __nuxt_page_meta$9 || {},
        component: () => import('./ProjectContainer-CfUnfzDM.mjs')
      },
      {
        name: "leader+UsersCenter",
        path: "UsersCenter",
        meta: __nuxt_page_meta$8 || {},
        component: () => import('./UsersCenter-C6hFFzM4.mjs')
      }
    ]
  },
  {
    name: "user",
    path: "/user",
    component: () => import('./user-Dg9S5PJz.mjs'),
    children: [
      {
        name: "user+index",
        path: "",
        meta: __nuxt_page_meta$7 || {},
        component: () => import('./index-CWovalOO.mjs')
      },
      {
        name: "user+MessageCenter",
        path: "MessageCenter",
        meta: __nuxt_page_meta$3 || {},
        component: () => import('./MessageCenter-CWAnHNib.mjs'),
        children: [
          {
            name: "user+MessageCenter+Notifications",
            path: "Notifications",
            meta: __nuxt_page_meta$6 || {},
            component: () => import('./Notifications-57MziOYS.mjs')
          },
          {
            name: "user+MessageCenter+Todos-[type]+[id]",
            path: "Todos-:type()/:id()",
            meta: __nuxt_page_meta$5 || {},
            component: () => import('./_id_-qIM2ZWwf.mjs')
          },
          {
            name: "user+MessageCenter+Todos",
            path: "Todos",
            meta: __nuxt_page_meta$4 || {},
            component: () => import('./Todos-O1VaJ1QX.mjs')
          }
        ]
      },
      {
        name: "user+ProjectCenter-[type]+[id]",
        path: "ProjectCenter-:type()/:id()",
        meta: __nuxt_page_meta$2 || {},
        component: () => import('./_id_-CWJlXX-T.mjs')
      },
      {
        name: "user+ProjectCenter",
        path: "ProjectCenter",
        meta: __nuxt_page_meta$1 || {},
        component: () => import('./ProjectCenter-5uID2MHn.mjs')
      },
      {
        name: "user+ProjectContainer",
        path: "ProjectContainer",
        meta: __nuxt_page_meta || {},
        component: () => import('./ProjectContainer-AMZA6Dme.mjs')
      }
    ]
  }
];
...
const getUserRole = (account) => {
  return roleMapping[account] || roleMapping.default;
};
const useLogin = () => {
  ...
  const getToken = () => {
    return useCookie(tokenKey).value || null;
  };
  const login = async () => {
    const userRole = getUserRole(loginForm.account);
    useCookie(tokenKey).value = userRole;
    await navigateTo(appConfig[userRole]);
  };
  const logout = async () => {
...
const LazyIcon = defineAsyncComponent(() => import('./index-BKXO7Wqw.mjs').then((r) => r["default"] || r.default || r));
...
var TooltipHTMLContent = (
  ...
  function() {
    function TooltipHTMLContent2(api, opt) {
      ...
      var container = appendTo && (isString$2(appendTo) ? (void 0).querySelector(appendTo) : isDom(appendTo) ? appendTo : isFunction(appendTo) && appendTo(api.getDom()));
...
const layouts = {
  admin: () => import('./admin-DZ79CgeQ.mjs'),
  parent: () => import('./parent-CchozSFO.mjs')
};
...
const ErrorComponent = /* @__PURE__ */ _export_sfc$1(_sfc_main$1, [["__scopeId", "data-v-33af4206"]]);
const _sfc_main = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
...
const server = /*#__PURE__*/Object.freeze({
    ...
    $: install,
    A: getDefaultLabel,
    B: toggleHoverEmphasis,
    C: getECData,
    D: removeElement,
    E: ElConfigProvider,
    F: normalizeSymbolSize,
    G: traverseElements,
    H: isDimensionStacked,
    I: createFloat32Array,
    J: convertToColorString,
    K: setStatesStylesFromModel,
    L: queryDataIndex,
    M: ChartView,
    N: setStatesFlag,
    O: getDefaultInterpolatedLabel,
    P: interpolateRawValues,
    Q: labelInner,
    R: SPECIAL_STATES,
    S: SeriesModel,
    T: isCoordinateSystemType,
    U: createGridClipPath,
    V: createPolarClipPath,
    W: createRenderPlanner,
    X: dataSample,
    Y: use,
    Z: install$5,
    _: _export_sfc$1,
    a: __nuxt_component_0$1,
    a$: createOrUpdatePatternFromDecal,
    a0: install$1,
    a1: install$4,
    a2: isBoolean,
    a3: isUndefined,
    ...
    a9: ElIcon,
    aA: parsePercent,
    aB: prepareLayoutList,
    aC: shiftLayoutOnX,
    aD: shiftLayoutOnY,
    aE: hideOverlap,
    aF: isElementRemoved,
    aG: animateLabelValue,
    aH: linearMap,
    aI: getLayoutRect,
    aJ: getSectorCornerRadius,
    aK: removeElementWithFadeOut,
    aL: prepareSeriesDataSchema,
    aM: SeriesData,
    aN: makeSeriesEncodeForNameBased,
    aO: getPercentSeats,
    aP: defaultEmphasis,
    aQ: createLegacyDataSelectAction,
    aR: normalizeCssArray,
    aS: ComponentModel,
    aT: createTextStyle,
    aU: windowOpen,
    aV: ComponentView,
    aW: isNameSpecified,
    aX: Model,
    aY: enableHoverEmphasis,
    aZ: setTooltipConfig,
    a_: box,
    aa: loading_default,
    ab: debugWarn,
    ac: caret_right_default,
    ad: useEventListener,
    ae: iconPropType,
    af: useLocale,
    ag: formItemContextKey,
    ah: withInstall,
    ai: useId,
    aj: useFormItem,
    ak: useFormItemInputId,
    al: useEmptyValues,
    am: ValidateComponentsMap,
    an: useFormSize,
    ao: isNumber,
    ap: useResizeObserver,
    aq: buildProps,
    ar: useSizeProp,
    as: definePropType,
    at: circle_close_default,
    au: arrow_down_default,
    av: useEmptyValuesProps,
    aw: useMutationObserver,
    ax: withNoopInstall,
    ay: DISPLAY_STATES,
    az: makeInner,
    b: ElButton,
    b0: getLayoutParams,
    b1: inheritDefaultOption,
    b2: mergeLayoutParam,
    b3: createIcon,
    b4: isEmpty,
    b5: clock_default,
    ...
    b9: getStyle,
    bA: defineStore,
    bB: asyncDataDefaults,
    bC: createError,
    bD: useAppConfig,
    bE: useHead,
    bF: more_default,
    bG: __nuxt_component_0,
    ba: arrow_up_default,
    bb: hasClass,
    bc: d_arrow_left_default,
    bd: arrow_left_default,
    be: arrow_right_default,
    bf: d_arrow_right_default,
    bg: throwError$1,
    bh: CloseComponents,
    bi: useZIndex,
    bj: useGlobalConfig,
    ...
    bt: hide_default,
    bu: buildProp,
    bv: tryOnScopeDispose,
    bw: useGetDerivedNamespace,
    bx: useIdInjection,
    by: componentSizes,
    bz: close_default,
    c: useRouter,
    ...
    v: saveOldStyle,
    w: initProps,
    x: getLabelStatesModels,
    y: normalizeSymbolOffset,
    z: setLabelStyle
});

export { install$4 as $, setLabelStyle as A, getDefaultLabel as B, toggleHoverEmphasis as C, getECData as D, ElConfigProvider as E, removeElement as F, normalizeSymbolSize as G, convertToColorString as H, setStatesStylesFromModel as I, queryDataIndex as J, ChartView as K, setStatesFlag as L, getDefaultInterpolatedLabel as M, interpolateRawValues as N, labelInner as O, isDimensionStacked as P, createFloat32Array as Q, SPECIAL_STATES as R, SeriesModel as S, isCoordinateSystemType as T, createGridClipPath as U, createPolarClipPath as V, use as W, install$5 as X, install as Y, install$1 as Z, _export_sfc$1 as _, __nuxt_component_0$1 as a, hasClass as a$, traverseElements as a0, dataSample as a1, createRenderPlanner as a2, useNamespace as a3, ElIcon as a4, loading_default as a5, caret_right_default as a6, iconPropType as a7, useLocale as a8, formItemContextKey as a9, inheritDefaultOption as aA, mergeLayoutParam as aB, createIcon as aC, buildProps as aD, definePropType as aE, circle_close_default as aF, useSizeProp as aG, useEmptyValuesProps as aH, useFormItem as aI, useEmptyValues as aJ, debugWarn as aK, clock_default as aL, calendar_default as aM, useFormSize as aN, onClickOutside as aO, unrefElement as aP, d_arrow_left_default as aQ, d_arrow_right_default as aR, DISPLAY_STATES as aS, parsePercent as aT, prepareSeriesDataSchema as aU, SeriesData as aV, normalizeCssArray as aW, isEmpty as aX, createLegacyDataSelectAction as aY, linearMap as aZ, shiftLayoutOnY as a_, withInstall as aa, isBoolean as ab, isUndefined as ac, isPropAbsent as ad, _export_sfc as ae, useEventListener as af, removeClass as ag, addClass as ah, makeInner as ai, getSectorCornerRadius as aj, removeElementWithFadeOut as ak, makeSeriesEncodeForNameBased as al, getPercentSeats as am, defaultEmphasis as an, ComponentModel as ao, createTextStyle as ap, windowOpen as aq, getLayoutRect as ar, ComponentView as as, isNameSpecified as at, Model as au, enableHoverEmphasis as av, setTooltipConfig as aw, box as ax, createOrUpdatePatternFromDecal as ay, getLayoutParams as az, ElButton as b, arrow_left_default as b0, arrow_right_default as b1, prepareLayoutList as b2, shiftLayoutOnX as b3, hideOverlap as b4, isElementRemoved as b5, animateLabelValue as b6, getStyle as b7, arrow_up_default as b8, arrow_down_default as b9, useTimeoutFn as bA, useMutationObserver as bB, useAppConfig as bC, useHead as bD, asyncDataDefaults as bE, createError as bF, more_default as bG, __nuxt_component_0 as bH, server as bI, isNumber as ba, buildProp as bb, useId as bc, addUnit as bd, useResizeObserver as be, useGetDerivedNamespace as bf, useIdInjection as bg, useZIndex as bh, isElement as bi, tryOnScopeDispose as bj, isClient as bk, throwError$1 as bl, useFormItemInputId as bm, useFormDisabled as bn, ValidateComponentsMap as bo, view_default as bp, hide_default as bq, withNoopInstall as br, getProp as bs, componentSizes as bt, close_default as bu, useDeprecated as bv, defineStore as bw, CloseComponents as bx, useGlobalConfig as by, defaultNamespace as bz, useRouter as c, ElForm as d, ElFormItem as e, storeToRefs as f, useLogin as g, user_default as h, navigateTo as i, useNuxtApp as j, key_default as k, useRuntimeConfig as l, __extends as m, nuxtLinkDefaults as n, createSeriesData as o, createSymbol as p, enterEmphasis as q, resolveRouteObject as r, search_default as s, leaveEmphasis as t, useRoute as u, updateProps$1 as v, saveOldStyle as w, initProps as x, getLabelStatesModels as y, normalizeSymbolOffset as z };
