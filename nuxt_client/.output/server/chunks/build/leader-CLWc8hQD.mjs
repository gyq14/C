...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/leader.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const leader = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { leader as default };
//# sourceMappingURL=leader-CLWc8hQD.mjs.map
