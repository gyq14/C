...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "ProjectContainer",
  __ssrInlineRender: true,
  setup(__props) {
    const router = useRouter();
    const projectsStore = useProjectsStore();
    const { completedProjects } = storeToRefs(projectsStore);
    const searchQuery = ref("");
    const filteredProjects = computed(() => {
      return completedProjects.value.filter(
    ...
    const goToProjectDetail = (id) => {
      router.push(`/leader/ProjectCenter-ProjectContainer/${id}`);
    };
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-2834bec7><div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "margin-bottom": "20px" })}" data-v-2834bec7>`);
      ...
      _push(`<div style="${ssrRenderStyle({ "margin-left": "20px" })}" data-v-2834bec7>\u5408\u8BA1 ${ssrInterpolate(filteredProjects.value.length)} \u6761</div></div>`);
      _push(ssrRenderComponent(_component_el_space, { wrap: "" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            ssrRenderList(filteredProjects.value, (project) => {
              _push2(`<div class="custom-card" data-v-2834bec7${_scopeId}><span class="card-header" data-v-2834bec7${_scopeId}><div data-v-2834bec7${_scopeId}>${ssrInterpolate(project.name)}</div>`);
              ...
              _push2(`<div class="card-content" data-v-2834bec7${_scopeId}><strong data-v-2834bec7${_scopeId}>\u5907\u6CE8:</strong> ${ssrInterpolate(project.description)}</div></div>`);
            });
            _push2(`<!--]-->`);
          } else {
            return [
              (openBlock(true), createBlock(Fragment, null, renderList(filteredProjects.value, (project) => {
                return openBlock(), createBlock("div", {
                  key: project.id,
                  class: "custom-card",
                  onDblclick: ($event) => goToProjectDetail(project.id)
                }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/leader/ProjectContainer.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ProjectContainer = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["__scopeId", "data-v-2834bec7"]]);

export { ProjectContainer as default };
//# sourceMappingURL=ProjectContainer-CfUnfzDM.mjs.map
