...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div style="${ssrRenderStyle({ "display": "flex" })}" data-v-060549c6><div style="${ssrRenderStyle({ "width": "20%", "margin-right": "20px" })}" data-v-060549c6>`);
      ...
      _push(`<div style="${ssrRenderStyle({ "width": "80%" })}" data-v-060549c6><div style="${ssrRenderStyle({ "display": "flex", "align-items": "center", "margin-bottom": "20px" })}" data-v-060549c6>`);
      ...
      _push(`<div style="${ssrRenderStyle({ "margin-left": "20px" })}" data-v-060549c6>\u5408\u8BA1 ${ssrInterpolate(filteredTableData.value.length)} \u6761</div></div>`);
      ...
      _push(ssrRenderComponent(_component_el_dialog, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<span slot="footer" class="dialog-footer" data-v-060549c6${_scopeId}>`);
...
const User = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["__scopeId", "data-v-060549c6"]]);

export { User as default };
//# sourceMappingURL=User-BYzt3cN9.mjs.map
