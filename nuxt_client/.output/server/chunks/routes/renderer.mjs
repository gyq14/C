...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"zh-cmn-Hans"},"charset":"utf-8","viewport":"width=device-width, initial-scale=1","title":"协同系统(供应商)"};
...
const getServerEntry = () => import('../build/server.mjs').then(function (n) { return n.bI; }).then((r) => r.default || r);
